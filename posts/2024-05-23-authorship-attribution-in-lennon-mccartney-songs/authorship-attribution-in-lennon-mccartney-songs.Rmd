...
[@Glickman2019Data]. An enjoyable read. The authors present a statistical analysis of the Beatles' repertoire from the point of view of authorship (Lennon *vs.* McCartney), a [topic with which I've been lately involved](https://vgherard.github.io/posts/2024-04-25-grammar-as-a-biometric-for-authorship-verification/). As a side-note, this also made me discover the [Harvard Data Science Review](https://hdsr.mitpress.mit.edu/).
...
My second point is a technical one and concerns how they construct confidence intervals for fitted probabilities. The construction resembles that of bootstrap percentile confidence intervals but, rather than the usual bootstrap synthetic datasets, the delete-one datasets used in leave-one-out cross-validation are used to obtain replicas of the fitted probabilities. This is nothing but Jackknife resampling in disguise, and it is well known that the resampling standard deviation of such Jackknife replicae is roughly $N ^{-1/2}$ times the true standard deviation, see *e.g.* [@tibshirani1993introduction]. Therefore, I have strong reasons to believe that the reported intervals strongly underestimate the uncertainty associated with these probability estimates.
