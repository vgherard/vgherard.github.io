...
[^1]: In the previous example, assuming a large sample size $N$ so that we can approximate the $t$ distribution with a normal one, the $1-\alpha$-level lower limit on $\mu$ (appropriate for a one-sided test of the null hypothesis $\mu \leq 0$) is given by: 
$$
