...
the subject not to incur into a sure loss, the rule $E\mapsto p(E)$ must 
...
bets is a sure loss (of an amount $p-q$). We can conclude that the degree of 
...
cases, you face a sure loss of an amount $\vert 1 - p\vert$, unless $p = 1$.
...
a sure loss. If $r > p + q$, your opponent could also force you into a 
sure loss by reversing the bet directions in the previous argument.
...
reversing the direction of these bets also leads to a sure loss for the 
