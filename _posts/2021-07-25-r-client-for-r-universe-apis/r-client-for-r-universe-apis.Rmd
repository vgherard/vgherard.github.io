...
description: |
  Introducing W.I.P. {runiv}, an R package to interact with R-universe 
  repository APIs
author:
  - name: vgherard
...
Since this has already proved to be useful to me (and could hopefully be so 
also to others), I started playing around to implement an R client for R-universe APIs. The package is called `runiv` and the code is [here](https://github.com/vgherard/runiv). Up to now, only a small subset of the 
full API features are available. You can peek at the development version from 
GitHub, using:
...
I hope you find this useful. I have very little experience with web API R 
packages (this was another personal reason to tackle this), so that if you have
any suggestion, or maybe want to collaborate on `runiv`, you are welcome to reach 
out to me through [GitHub](https://github.com/vgherard/runiv).
