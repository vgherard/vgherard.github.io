...
checks, the FPR is already close to 10%, almost twice the FPR of the individual
tests:
...
the whole point of running a formal test 
(instead of simply collecting some data and making an educated guess) looks very 
dubious to me. Other story is if you are able to tell *in advance* how interim 
checks affect FPR/FNR, and use this knowledge to optimize your analysis 
procedure - this post provides some basic tools to do so.
